...
async function starts() {
	    ...
	    client.browserDescription = ["ZANXD","Ubuntu","18.04"]
	    client.logger.level = 'warn'
	    console.log(color(`]─`,`magenta`),`「`,  color(`ZANXD YT`,`red`), `」`,  color(`─[`,`magenta`))
	    client.on('qr', () => {
	    console.log(color('[','white'), color('!','red'), color(']','white'), color(' SCAN BANG WAKTU RESET QR 20 DETIK'))
	    })
	    ...
	    client.on('open', () => {
	    success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
	    teks = "BOT BERHASIL TERHUBUNG JANGAN LUPA SUBSCRIBE ZANXD YT"
